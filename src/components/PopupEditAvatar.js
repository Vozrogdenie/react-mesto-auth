...
function PopupEditAvatar(props) {
    ...
    return (
        <PopupWithForm name="new-avatar" onSubmit={handleSubmit} opened={props.opened} title='Обновить аватар?'  buttonText={props.buttonText} onClosePopup={props.onClosePopup}>
