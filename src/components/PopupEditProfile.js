...
function PopupEditProfile(props) {
    ...
    return (
        <PopupWithForm name="edit" opened={props.opened} onClosePopup={props.onClosePopup} title='Редактировать профиль' onSubmit={handleSubmit} buttonText={props.buttonText} >
